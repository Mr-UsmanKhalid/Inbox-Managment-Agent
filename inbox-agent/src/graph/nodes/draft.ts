import { z } from "zod";
import { AgentState, DraftResponse } from "../../types.js";
    ...
    const result = await model.invoke([
      {
        role: "system",
        content:
          "You draft customer support/sales email replies for a business. Use ONLY the provided " +
...
function mockDraft(body: string, context: string, name?: string, category?: string): DraftResponse {
